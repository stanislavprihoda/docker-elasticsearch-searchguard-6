...
# custom-update: Setting this flag will disable any commercial module or custom authentication domain and will run only the free Community features of Search Guard. 
echo "searchguard.enterprise_modules_enabled: false" | $SUDO_CMD tee -a "$ES_CONF_FILE" > /dev/null
